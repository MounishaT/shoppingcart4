...
public class TestCaseUserDetails {
	...
	{
		userDetails.setId("450");
		userDetails.setName("mounisha");
		userDetails.setPassword("mounisha");
		userDetails.setMail("mounisha.com");
		userDetails.setContact("9849523808");
		userDetails.setAddress("madhavapuri hills");
