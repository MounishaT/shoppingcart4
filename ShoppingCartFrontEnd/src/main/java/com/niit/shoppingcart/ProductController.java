...
/*                  Category category=categoryDAO.getByName(product.getCategory().getCat_name());
     ...
     /*          product.setCategory_id(category.getCat_id());
              ...
              if (productDAO.get(product.getProd_id()) == null) {
                  ...
                  FileUtil.upload(Path, file, product.getProd_id()+".jpg");
	...
	@RequestMapping("product/remove/{prod_id}")
	public String removeProduct(@PathVariable("prod_id") String id)
	{
	...
	@RequestMapping("product/edit/{prod_id}")
	public String removeProduct(@PathVariable("prod_id") String id,Model model){
	...
	/*@RequestMapping("product/get/{prod_id}")
	public String getSelectedProduct(@PathVariable("prod_id") String id,Model model,
