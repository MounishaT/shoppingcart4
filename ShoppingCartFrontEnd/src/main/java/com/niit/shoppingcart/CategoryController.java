...
public class CategoryController {
 ...
 Logger log=Logger.getLogger(CategoryController.class);
	...
	public String addCategory(@ModelAttribute("category") Category category) {
		...
		if (categoryDAO.get(category.getctgy_id()) == null) {
	...
	@RequestMapping(value= "category/update/{ctgy_id}")
	public String updateCategory(@PathVariable("ctgy_id") String id ) {
	...
	@RequestMapping("category/remove/{ctgy_id}")
	public String  deleteCategory(@PathVariable("ctgy_id") String id)
			throws Exception {
