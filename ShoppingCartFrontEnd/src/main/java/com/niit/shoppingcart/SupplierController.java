...
public class SupplierController {
	...
	public String addSupplier(@ModelAttribute("supplier") Supplier supplier) {
		...
		if (supplierDAO.get(supplier.getSupl_id()) == null) {
	...
	@RequestMapping(value= "supplier/update/{supl_id}")
	public String updateCategory(@PathVariable("supl_id") String id ) {
		...
		//String id=supplier.getId();
		 supplier=supplierDAO.get(id);
			System.out.println(supplier.getSupl_id());
	...
	@RequestMapping("/supplier/remove/{supl_id}")
	public String deletesupplier(@PathVariable("supl_id") String id) throws Exception {
